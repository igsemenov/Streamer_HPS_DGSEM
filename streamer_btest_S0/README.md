...
At the end of the simulation, the folders pydata\time_#, with #=0,1,2,3,4,5, contain the simulation results for the time moments t=0,0.5,1.0,1.5,2.0,2.5ns, respectively.
