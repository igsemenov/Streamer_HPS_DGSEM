...
rib[0]=dg.dgs_rib([fld[0],fld[1],fld[2]],3)
rib[1]=dg.dgs_rib([fld[0],fld[1],fld[2]],2)

rib[2]=dg.dgs_rib([fld[1],fld[0]],1)
rib[3]=dg.dgs_rib([fld[2],fld[2]],1)

rib[4]=dg.dgs_rib([fld[0],fld[1]],1)
