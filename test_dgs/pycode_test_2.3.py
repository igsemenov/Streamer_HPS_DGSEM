...
Introduction:
    ...
    The computation is run till t=0.5.
...
nod_[4]=lg.nod2d([4.*np.pi,0.],[2.*np.pi,2.*np.pi],lgn)
...
rib_[4]=dg.dgs_rib([fld_[3],fld_[2]],0)
rib_[5]=dg.dgs_rib([fld_[1],fld_[0]],0)

rib_[6]=dg.dgs_rib([fld_[4],fld_[4]],0)

rib_[7]=dg.dgs_rib([fld_[2],fld_[3],fld_[4]],5)
rib_[8]=dg.dgs_rib([fld_[0],fld_[1],fld_[4]],4)
