...
2. Run pycode_t=s.py sequentially using time_moment=0,...,15.

At the end of the simulation, the folders pydata\time_#, with #=0,...,16, contain the simulation results corresponding to the time moments from 0.0 to 16 ns, respectively.
...
Here E0=15.0 is the background electric field.
