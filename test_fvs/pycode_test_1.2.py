...
Introduction:
    ...
    The considered test problem is Test 1.2.
...
fld[2]=fv.fvs_box2d([+0.,+4.],[4.,4.],fvs)
...
rib[0]=fv.fvs_rib([fld[0],fld[1],fld[2]],3)
rib[1]=fv.fvs_rib([fld[0],fld[1],fld[2]],2)

rib[2]=fv.fvs_rib([fld[1],fld[0]],1)
rib[3]=fv.fvs_rib([fld[2],fld[2]],1)

rib[4]=fv.fvs_rib([fld[0],fld[1]],1)
...
for fld_ in fld:
    ...
    r=gauss(fld_.x-x0,fld_.y-y0,0.,0.25,bx_,nt*dt)
