...
Introduction:
    ...
    The computation is performed for until  t=1.
...
fld_[4]=fv.fvs_box2d([0.,-4.*np.pi],[2.*np.pi,2.*np.pi],fvs)
...
rib_[4]=fv.fvs_rib([fld_[3],fld_[1]],1)
rib_[5]=fv.fvs_rib([fld_[2],fld_[0]],1)

rib_[6]=fv.fvs_rib([fld_[4],fld_[4]],1)

rib_[7]=fv.fvs_rib([fld_[0],fld_[2],fld_[4]],2)
rib_[8]=fv.fvs_rib([fld_[1],fld_[3],fld_[4]],3)
